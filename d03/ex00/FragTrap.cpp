...
FragTrap::~FragTrap() {
	std::cout << "FR4G-TP Bot " << this->name << " has been deleted" << std::endl;	
};
...
FragTrap::FragTrap() {
	...
	std::cout << "Bot " << this->name << " has been created" << std::endl;
};
...
FragTrap::FragTrap(std::string name) {
	...
	this->ranged_attack_damage = 20;
	this->armor_damage_reduction = 5;
	std::cout << "FR4G-TP Bot " << this->name << " has been created" << std::endl;
};
